...
function downloadResume(event) {
    ...
    const loadingContainers = document.querySelectorAll(".loading_container");

    loadingBars.forEach(bar => bar.style.width = "0%");
    loadingContainers.forEach(container => container.style.display = "block");

    let width = 0;
    const interval = setInterval(() => {
        width += 5; // Slower loading
        loadingBars.forEach(bar => bar.style.width = width + "%");
        ...
        if (width >= 100) {
            ...
            setTimeout(() => {
                ...
                window.open("assets/images/resume/Resume.pdf", "_blank");
            }, 500); // Ensures opening occurs at the end of loading
        }
    }, 200); // Slower intervals
}
(function ($) {
    "use strict";
