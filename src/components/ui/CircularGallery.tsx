...
class Media {
    ...
    onResize({ screen, viewport } = {}) {
        ...
        const baseHeight = isMobile ? 700 : 900;
        const baseWidth = isMobile ? 550 : 700;
        ...
        // Recalculate extra based on new width
        const oldWidthTotal = this.widthTotal;
        this.widthTotal = this.width * this.length;
        if (oldWidthTotal > 0) {
            this.extra = (this.extra / oldWidthTotal) * this.widthTotal;
        }
